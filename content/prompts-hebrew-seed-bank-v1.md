...
- all prompts are **gender neutral** (no gendered pronouns or verb forms)

## Unique Prompts

1. **מה כבר ברור לך, אבל עוד לא נאמר בקול?**  
...
4. **איפה מושקע יותר ממה שבאמת חשוב לך?**  
   Tags: Values, Patterns

5. **מה נדחה אצלך בגלל סיבה שכבר לא רלוונטית?**  
   Tags: Fears, Habits

6. **מה חשוב לך לשמור בשליטה עכשיו?**  
   Tags: Fears, Patterns

7. **על מה נאמר "אין לי זמן" כשבעצם אין רצון?**  
   Tags: Values, Habits

8. **איזה חלק ביום שלך מרגיש הכי אמיתי?**  
   Tags: Identity, Meaning

9. **איזו אמת נאמרת לאחרים, וקשה לך לחיות אותה?**  
   Tags: Identity, Relationships

10. **איזה צורך שלך קיבל הכי מעט מקום השבוע?**  
    Tags: Emotions, Values

11. **מה נעשה לאחרונה על אוטומט?**  
    Tags: Habits, Patterns

12. **איפה יש נטייה להקטין את עצמך כדי שיהיה פשוט יותר?**  
    Tags: Identity, Relationships
...
15. **איזה מחיר שקט משולם על משהו שנראה "בסדר"?**  
    Tags: Patterns, Meaning

16. **מה ממשיך להיסחב רק מתוך הרגל?**  
    Tags: Habits, Patterns
...
19. **לאיזה אישור עדיין מחכים, למרות שהוא לא באמת צריך להגיע?**  
    Tags: Identity, Relationships
...
29. **מה ידוע לך על עצמך היום שלא היה ידוע לפני שנה?**  
    Tags: Identity, Patterns

30. **מה נשאר מוסתר גם מעצמך?**  
    Tags: Fears, Identity

## Notes

- All prompts are written in gender-neutral Hebrew: no gendered pronouns (אתה/את) or gendered verb forms.
- Techniques used: "לך" (dative), passive constructions, infinitives, and impersonal phrasing.
- Gender-specific versions can be generated at runtime when the user's gender is known.
- These prompts should be reviewed aloud in Hebrew before publishing.
- The bank intentionally leans toward direct, writable questions over clever phrasing.
