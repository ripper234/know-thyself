...
4. ~~Generate candidate first 30 questions.~~ → First Hebrew draft in `content/prompts-hebrew-seed-bank-v1.md`, Hebrew process in `content/hebrew-style-guide.md`. Review pass needed. See [#21](https://github.com/ripper234/know-thyself/issues/21) + [#25](https://github.com/ripper234/know-thyself/issues/25).
