...
First Principles
----------------
1. Spec-driven-development. Spec is THE source of truth. Aspiration: code generated purely from spec (not stored in source control). Research concluded this is not yet feasible; code lives in source control for now.
